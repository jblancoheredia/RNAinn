process STAR_FILBAM {
    ...
    script:
    def args = task.ext.args ?: "--readFilesCommand zcat --peOverlapNbasesMin 10 --peOverlapMMp 0.01 —-outSAMunmapped Within KeepPairs --outBAMcompression 0 --outFilterMultimapNmax 50 --alignEndsType Local --chimOutType WithinBAM SoftClip --outSAMattributes All --sjdbGTFfile $gtf"
    def prefix = task.ext.prefix ?: "${meta.id}"
    def suffix = "consensus_mapped" 
    def reads1 = [], reads2 = []
    ...
    STAR \\
        ...
        --runThreadN 1 \\
        --outFileNamePrefix ${prefix}_${suffix} \\
