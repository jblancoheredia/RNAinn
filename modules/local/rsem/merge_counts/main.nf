process RSEM_MERGE_COUNTS {
    ...
    def prefix  = task.ext.prefix ?: "${meta.id}"
    """
    touch ${prefix}.rsem.merged.gene_counts.tsv
    touch ${prefix}.rsem.merged.gene_tpm.tsv
    touch ${prefix}.rsem.merged.transcript_counts.tsv
    touch ${prefix}.rsem.merged.transcript_tpm.tsv
