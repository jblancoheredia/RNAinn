...
include { RNAINN_GENE_EXPRESSN                                                  } from '../subworkflows/local/gene_expressn'
include { RNAINN_FUSION_SPLICE                                                  } from '../subworkflows/local/fusion_splice'
...
workflow RNAINN {
    ...
    ch_reads_all                = RNAINN_PREPROCESSING.out.all_reads
    ...
    ch_versions                 = ch_versions.mix(RNAINN_PREPROCESSING.out.versions)
    ch_multiqc_files            = ch_multiqc_files.mix(RNAINN_PREPROCESSING.out.multiqc_files)

    //
    // SUBWORKFLOW: Run Fusion/Junction/Splicing discovery
    //
    RNAINN_FUSION_SPLICE(
        ch_gtf,
        ch_fasta,
        ch_chrgtf,
        ch_versions,
    ...
    ch_versions                 = ch_versions.mix(RNAINN_FUSION_SPLICE.out.versions)
    ch_multiqc_files            = ch_multiqc_files.mix(RNAINN_FUSION_SPLICE.out.multiqc_files)

    //
    // SUBWORKFLOW: Run Gene Expression / Counts
    //
    RNAINN_GENE_EXPRESSN(
        ch_gtf,
        ch_fasta,
        ch_rsem_ref,
        ch_versions,
...
//    ch_subread_feature_counts   = RNAINN_GENE_EXPRESSN.out.subread_feature_counts
    ch_versions                 = ch_versions.mix(RNAINN_GENE_EXPRESSN.out.versions)
    ch_multiqc_files            = ch_multiqc_files.mix(RNAINN_GENE_EXPRESSN.out.multiqc_files)
    
//    //
//    // SUBWORKFLOW: Run Variant Calling
//    //
//    RNAINN_CALL_VARIANTS(
//        ch_bed,
//        ch_multiqc_files,
//
//    )
